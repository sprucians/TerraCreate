onEvent('recipes',event => {
    ...
    let woodname;
    for (woodname of ["acacia", "ash", "aspen", "birch", "blackwood", "chestnut", "douglas_fir", "hickory", "kapok", "maple", "oak", "palm", "pine", "rosewood", "sequoia", "spruce", "sycamore", "white_cedar", "willow"]){
        event.custom({
            "type" : "create:cutting",
