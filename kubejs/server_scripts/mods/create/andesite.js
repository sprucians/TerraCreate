...
let hoe = ['tfc:metal/hoe_head/bismuth_bronze', 'tfc:metal/hoe_head/black_bronze', 'tfc:metal/hoe_head/bronze']

onEvent('tags.items', e => {
    e.add('kubejs:bronze_ingot', bronze);
    e.add('kubejs:bronze_sheet', sheet);
    e.add('kubejs:bronze_hoe_head', hoe);
    e.add('kubejs:bronze_saw_blade', saw);
})
...
onEvent('recipes', e => {
    ...
    e.smithing('create:mechanical_saw', 'create:andesite_casing', '#kubejs:bronze_saw_blade')
    e.smithing('create:mechanical_plough', 'create:andesite_casing', '#kubejs:bronze_sheet')
    ...
    e.smithing('create:mechanical_harvester', 'create:andesite_casing', '#kubejs:bronze_hoe_head')
